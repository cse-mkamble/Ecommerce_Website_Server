const activationTokenMail = (name, url, CONTACT_US) => {
    return `
        <div>
                                ...
                                <div style=" padding: 20px 4px; background: #fff; border-radius: 10px; ">
                                    <div cellpadding="0" cellspacing="0" width="100%">
                                        <div align="center">
                                            ...
                                            <div>
                                                <img alt=""
                                                    src="https://res.cloudinary.com/aztec/image/upload/v1628834238/logoaztecanimation_vrqn8w.gif"
                                                    style=" width: 300px; " />
                                            </div>
                                            <div
                                                ...
                                                <br>
                                                Just click the button below to confirm your email address.
                                            </div>
                                            <div>
                                                <a href=${url}
...
module.exports = activationTokenMail